...
public class CaseController {
    ...
    public ResponseEntity<MemberResponse> addMember(
        ...
        // Check if requester is allowed to add members (must be LAWYER or ADMIN)
        ...
        CaseMember member = caseService.addMemberToCaseByEmail(id, request.getEmail(), request.getRole(), requesterId);
    ...
    public ResponseEntity<List<MemberResponse>> addMembersBulk(
        ...
        List<com.legalcase.entity.CaseMember> members = caseService.addMembersToCaseByEmails(
                id, request.getEmails(), request.getRole(), requesterId);
